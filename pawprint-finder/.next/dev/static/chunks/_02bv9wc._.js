...
;
;
var supabaseUrl = ("TURBOPACK compile-time value", "https://qyyygvvdksdmcpfomeul.supabase.co");
var supabaseKey = ("TURBOPACK compile-time value", "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InF5eXlndnZka3NkbWNwZm9tZXVsIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NzE1MzgwODksImV4cCI6MjA4NzExNDA4OX0.db1-F9A93gmFvmgRJkY1wqPYAbntPoSVouSCyyDx5FY");
var supabase = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$supabase$2f$supabase$2d$js$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["createClient"])(supabaseUrl, supabaseKey);
...
function AuthProvider(param) {
    ...
    var _useState1 = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$swc$2f$helpers$2f$esm$2f$_sliced_to_array$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_"])((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null), 2), session = _useState1[0], setSession = _useState1[1];
    ...
    var _useState3 = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$swc$2f$helpers$2f$esm$2f$_sliced_to_array$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_"])((0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(null), 2), userRole = _useState3[0], setUserRole = _useState3[1];
    var fetchUserRole = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "AuthProvider.useCallback[fetchUserRole]": function(userId) {
            return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$swc$2f$helpers$2f$esm$2f$_async_to_generator$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_"])({
                "AuthProvider.useCallback[fetchUserRole]": function() {
                    var _ref, data, _$error, error, /* eslint-disable */ _console;
                    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$tslib$2f$tslib$2e$es6$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__$5f$_generator__as__$5f3e$__["_"])(this, {
                        "AuthProvider.useCallback[fetchUserRole]": function(_state) {
                            switch(_state.label){
                                case 0:
                                    _state.trys.push([
                                        0,
                                    ...
                                    return [
                                        4,
                                        __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2f$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from('profiles').select('role').eq('id', userId).single()
                                    ];
                                case 1:
                                    _ref = _state.sent(), data = _ref.data, _$error = _ref.error;
                                    if (_$error) throw _$error;
                                    setUserRole((data === null || data === void 0 ? void 0 : data.role) || 'user');
                                    return [
                                        3,
                                        3
                                    ];
                                case 2:
                                    error = _state.sent();
                                    (_console = console).error.apply(_console, (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$swc$2f$helpers$2f$esm$2f$_to_consumable_array$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_"])(oo_tx("1889524231_38_6_38_55_11", 'Error fetching user role:', error)));
                                    setUserRole('user');
                                    return [
                                        3,
                                        3
                    ...
                    }["AuthProvider.useCallback[fetchUserRole]"]);
                }
            }["AuthProvider.useCallback[fetchUserRole]"])();
        }
    }["AuthProvider.useCallback[fetchUserRole]"], [
        __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2f$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"]
    ]);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "AuthProvider.useEffect": function() {
            var initializeAuth = function initializeAuth() {
                return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$swc$2f$helpers$2f$esm$2f$_async_to_generator$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_"])({
                    "AuthProvider.useEffect.initializeAuth": function() {
                        var _ref, _ref1, _ref_data, initialSession, error, /* eslint-disable */ _console;
                        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$tslib$2f$tslib$2e$es6$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__$5f$_generator__as__$5f3e$__["_"])(this, {
                            "AuthProvider.useEffect.initializeAuth": function(_state) {
                                switch(_state.label){
                                    case 0:
                                        _state.trys.push([
                                            0,
                                        ...
                                        return [
                                            4,
                                            __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2f$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].auth.getSession()
                                        ];
                                    case 1:
                                        _ref1 = _state.sent(), _ref_data = _ref1.data, initialSession = _ref_data.session;
                                        setSession(initialSession);
                                        setUser((_ref = initialSession === null || initialSession === void 0 ? void 0 : initialSession.user) !== null && _ref !== void 0 ? _ref : null);
                                        if (!(initialSession === null || initialSession === void 0 ? void 0 : initialSession.user)) return [
                                            3,
                                            3
                                        ];
                                        return [
                                    ...
                                    case 4:
                                        error = _state.sent();
                                        (_console = console).error.apply(_console, (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$swc$2f$helpers$2f$esm$2f$_to_consumable_array$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_"])(oo_tx("1889524231_54_8_54_56_11", 'Error initializing auth:', error)));
                                        return [
                                            3,
                                            6
                                        ];
            ...
            initializeAuth();
            var _supabase_auth_onAuthStateChange = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2f$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].auth.onAuthStateChange({
                "AuthProvider.useEffect._supabase_auth_onAuthStateChange": function(_event, newSession) {
                    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$swc$2f$helpers$2f$esm$2f$_async_to_generator$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["_"])({
                        "AuthProvider.useEffect._supabase_auth_onAuthStateChange": function() {
                            var _ref;
                            return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$tslib$2f$tslib$2e$es6$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__$5f$_generator__as__$5f3e$__["_"])(this, {
                                "AuthProvider.useEffect._supabase_auth_onAuthStateChange": function(_state) {
                                    switch(_state.label){
                                        case 0:
                                            setSession(newSession);
                                            setUser((_ref = newSession === null || newSession === void 0 ? void 0 : newSession.user) !== null && _ref !== void 0 ? _ref : null);
                                            if (!(newSession === null || newSession === void 0 ? void 0 : newSession.user)) return [
                                                3,
                                                2
                                            ];
                                            return [
                            ...
                            }["AuthProvider.useEffect._supabase_auth_onAuthStateChange"]);
                        }
                    }["AuthProvider.useEffect._supabase_auth_onAuthStateChange"])();
                }
            }["AuthProvider.useEffect._supabase_auth_onAuthStateChange"]), subscription = _supabase_auth_onAuthStateChange.data.subscription;
            return ({
                "AuthProvider.useEffect": function() {
    ...
    var signUp = function signUp(email, password, fullName) {
            ...
            return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$tslib$2f$tslib$2e$es6$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__$5f$_generator__as__$5f3e$__["_"])(this, function(_state) {
                switch(_state.label){
                    case 0:
                        return [
                            4,
                            __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2f$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].auth.signUp({
                                email: email,
                                password: password,
                                options: {
                                    data: {
                                    ...
                                    emailRedirectTo: "".concat(("TURBOPACK compile-time value", "http://localhost:3000"), "/auth")
                                }
                            })
                        ];
                    case 1:
            ...
            return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$tslib$2f$tslib$2e$es6$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__$5f$_generator__as__$5f3e$__["_"])(this, function(_state) {
                switch(_state.label){
                    case 0:
                        return [
                            4,
                            __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2f$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].auth.signInWithPassword({
                                email: email,
                                password: password
                            })
                        ];
            ...
            return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$tslib$2f$tslib$2e$es6$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$export__$5f$_generator__as__$5f3e$__["_"])(this, function(_state) {
                switch(_state.label){
                    case 0:
                        return [
                            4,
                            __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$supabase$2f$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].auth.signInWithOAuth({
                                provider: 'google',
                                options: {
                                    redirectTo: "".concat(("TURBOPACK compile-time value", "http://localhost:3000"), "/auth/callback")
                                }
                            })
                        ];
                    case 1:
...
_s(AuthProvider, "IV7QIp1i/MrLlfOcBArvi+ntroI=");
_c = AuthProvider;
function useAuth() {
    _s1();
...
//# sourceMappingURL=_02bv9wc._.js.map